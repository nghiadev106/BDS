...
namespace BDS.Areas.Admin.Controllers
{
    ...
    public class FurnitureController : BaseController
    {
        ...
        public FurnitureController(IFurnitureService service, ITopicService topicService, IHostingEnvironment env)
        {
            _service = service;
        ...
        {
            var lstFurniture = await _service.GetAll();
            ViewBag.lstFurniture = lstFurniture;
            return View();
        }
        ...
        public async Task<IActionResult> Create(FurnitureCreateRequest request)
        {
            await loadCategory();
        ...
        [HttpPost]
        [Consumes("multipart/form-data")]
        public async Task<IActionResult> Edit(FurnitureUpdateRequest request)
        {
            await loadCategory();
            if (!ModelState.IsValid)
            {
